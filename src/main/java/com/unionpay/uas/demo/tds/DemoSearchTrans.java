...
public class DemoSearchTrans {
    private static final Logger logger = Logger.getLogger(DemoSearchTrans.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntTds.search.token.trans");        // 交易类型 根据实际业务填写
        ...
        timeRange.put("timeBegin","20211011");
        timeRange.put("timeEnd","20211011");
        bodyMap.put("timeRange", timeRange);

        // 需要加密的敏感信息报文 根据实际业务填写 (如果不带卡号查询则无需加密，省略这部分代码)
        Map<String, Object> encDataMap = new HashMap<>();

        Map<String, Object> encAcctInfo = new HashMap<>();
        encAcctInfo.put("acctNo", "6225580626018888");
    ...
    public static void rsa(){
        ...
        Map<String, Object> encAcctInfo = new HashMap<>();
        encAcctInfo.put("acctNo", "6225987827360182");
        encDataMap.put("acctInfo", encAcctInfo);
