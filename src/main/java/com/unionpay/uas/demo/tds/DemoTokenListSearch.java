...
public class DemoTokenListSearch {
    private static final Logger logger = Logger.getLogger(DemoTokenListSearch.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntTds.search.token.list");       // 交易类型 根据实际业务填写
        ...
        acctInfo.put("acctType","02");
        bodyMap.put("acctInfo", acctInfo);

        Map<String, Object> tokenInfo = new HashMap<>();
        tokenInfo.put("tokenSt","1");
        bodyMap.put("tokenInfo", tokenInfo);

        Map<String, Object> timeRange = new HashMap<>();
        timeRange.put("timeBegin","20220101");
        timeRange.put("timeEnd","20220302");
        ...
        encAcctInfo.put("acctNo", "123456789abcDEFGH");
