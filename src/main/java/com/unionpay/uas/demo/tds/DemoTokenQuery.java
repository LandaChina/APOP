...
public class DemoTokenQuery {
    private static final Logger logger = Logger.getLogger(DemoTokenQuery.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntTds.token.query");       // 交易类型 根据实际业务填写
    ...
    public static void rsa(){
        ...
        Map<String, Object> tokenInfo = new HashMap<>();
        tokenInfo.put("tokenId","6230746000826093037");
        bodyMap.put("tokenInfo", tokenInfo);
