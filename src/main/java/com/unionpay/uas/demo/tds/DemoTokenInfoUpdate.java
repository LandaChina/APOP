...
public class DemoTokenInfoUpdate {
    private static final Logger logger = Logger.getLogger(DemoTokenInfoUpdate.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntTds.token.update");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("tokenUpdTp", "02");

        Map<String, Object> tokenInfo = new HashMap<>();
        tokenInfo.put("tokenId","6230746000880009812");
        tokenInfo.put("tokenExpr","010000000000");
        tokenInfo.put("tokenUseNum","50");
        tokenInfo.put("tokenTranLmt","1000000");
        tokenInfo.put("tokenDayLmt","200000");
        bodyMap.put("tokenInfo", tokenInfo);

        List<String> merList = new ArrayList<>();
        merList.add("785152489632147");
        bodyMap.put("merList", merList);

        List<String> mccList = new ArrayList<>();
        mccList.add("0000");
        mccList.add("1222");
        bodyMap.put("mccList", mccList);
    ...
    public static void rsa(){
        ...
        bodyMap.put("txnDate", DemoUtil.getTxnTime().substring(0,8));
        bodyMap.put("txnNo", DemoUtil.getOrderId());
        bodyMap.put("trId", "62000002005");
        bodyMap.put("tokenUpdTp", "02");

        Map<String, Object> tokenInfo = new HashMap<>();
        tokenInfo.put("tokenId","6213140256000000259");
        tokenInfo.put("tokenExpr","010000000000");
        tokenInfo.put("tokenUseNum","50");
        tokenInfo.put("tokenTranLmt","1000000");
        tokenInfo.put("tokenDayLmt","200000");
