package com.unionpay.uas.demo.tds;
 ...
 */
public class DemoTokenApply {
    private static final Logger logger = Logger.getLogger(DemoTokenApply.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntTds.token.apply");       // 交易类型 根据实际业务填写
        reqData.put(SDKConstants.param_version, "1.0.0");                       // 版本号 根据实际业务填写
        reqData.put(SDKConstants.param_signMethod, "SM2");                      // 签名方法
        reqData.put(SDKConstants.param_appId, "88041000");                      // 发送方系统索引号 根据实际业务填写
        ...
        bodyMap.put("accessCd", "03080123");
        bodyMap.put("txnDate", DemoUtil.getTxnTime().substring(0,8));
        bodyMap.put("txnNo", DemoUtil.getOrderId());
        bodyMap.put("trId", "62000000001");
        bodyMap.put("merLmtRange", "0");
        bodyMap.put("merId", "987654321011111");
        bodyMap.put("chnlBit", "10000000");
        bodyMap.put("appNm", "ZhaoShangBank");

        Map<String, Object> acctInfo = new HashMap<>();
        acctInfo.put("acctType","01");
        acctInfo.put("certTp","01");
        acctInfo.put("acctUserId","acctUser123");
        bodyMap.put("acctInfo", acctInfo);

        Map<String, Object> tokenInfo = new HashMap<>();
        tokenInfo.put("tokenScene","05");
        tokenInfo.put("tokenExpr","010101010101");
        tokenInfo.put("tokenUseNum","99");
        tokenInfo.put("tokenTranLmt","000011112222");
        tokenInfo.put("tokenCardAttr","01");
        tokenInfo.put("tokenTpId","01");
        bodyMap.put("tokenInfo", tokenInfo);

        Map<String, Object> userInfo = new HashMap<>();
        userInfo.put("userCertTp","01");
        userInfo.put("userId","user123");
        bodyMap.put("userInfo", userInfo);


        Map<String, Object> encDataMap = new HashMap<>(); // 需要加密的敏感信息报文 根据实际业务填写

        Map<String, Object> encAcctInfo = new HashMap<>();
        encAcctInfo.put("acctNo", "6225988563850182");
        encAcctInfo.put("contactName", "乌芊");
        encAcctInfo.put("contactPhone", "17621236655");
        encAcctInfo.put("certNo", "330220198904017879");
        encDataMap.put("acctInfo", encAcctInfo);

        Map<String, Object> encUserInfo = new HashMap<>();
        encUserInfo.put("userContactName", "伊樊");
        encUserInfo.put("userContactPhone", "17621236655");
        encUserInfo.put("userCertNo", "330185198901017879");
        encDataMap.put("userInfo", encUserInfo);
    ...
    public static void rsa(){
        ...
        reqData.put(SDKConstants.param_appId, "03080123");        // 发送方系统索引号 根据实际业务填写
