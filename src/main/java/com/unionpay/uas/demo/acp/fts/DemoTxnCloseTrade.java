...
public class DemoTxnCloseTrade {

    private static final Logger logger = Logger.getLogger(DemoTxnCloseTrade.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "soluFts.fts.cis.txnCloseTrade");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("origOrderId", "");//原商户订单号
        bodyMap.put("origTxnTime", "");//yyyyMMHHhhmmss，原交易发起时间
