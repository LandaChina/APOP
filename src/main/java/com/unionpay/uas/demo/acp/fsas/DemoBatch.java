...
public class DemoBatch {
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntFsas.trade.batch");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("fileContent",fileContent);//敏感信息配置加密时注释这段代码
