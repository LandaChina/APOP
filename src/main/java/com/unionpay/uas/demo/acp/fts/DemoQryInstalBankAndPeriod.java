...
public class DemoQryInstalBankAndPeriod {

    private static final Logger logger = Logger.getLogger(DemoQryInstalBankAndPeriod.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "soluFts.fts.cis.qryInstalBankAndPeriod");       // 交易类型 根据实际业务填写
