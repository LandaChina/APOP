package com.unionpay.uas.demo.acp.payment;
 ...
 */
public class DemoCreditingInfo {

    private static final Logger logger = Logger.getLogger(DemoCreditingInfo.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.creditingInfo.info.request");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("acqInsCode", "");
        bodyMap.put("accessType", "");
        ...
        bodyMap.put("currencyCode", "");//交易币种,默认取值156
        bodyMap.put("txnAmt", "");//交易金额
        bodyMap.put("backUrl", "");//后台通知地址,接收“入账信息结果通知”的通讯地址。
        bodyMap.put("postScript", ""); //附言
        bodyMap.put("busiAbstract", "");//业务摘要
        ...
        bodyMap.put("sourcesOfFunds", "");//资金来源
        ...
        bodyMap.put("frontUrl", ""); //订单跳转地址

        //入账信息交易收款方信息
        Map<String, String> creditingInfoPayeeInfo = new HashMap<>();
        creditingInfoPayeeInfo.put("acctBankNo","");//开户行行号
        creditingInfoPayeeInfo.put("acctBankName","");//开户行名称
        creditingInfoPayeeInfo.put("accNo",""); //账号
        creditingInfoPayeeInfo.put("acctName",""); //账号名称
        creditingInfoPayeeInfo.put("accType",""); //账号类型
        creditingInfoPayeeInfo.put("businessLicenseRegNo",""); //统一社会信用代码
        creditingInfoPayeeInfo.put("contactName",""); //联系人姓名
        creditingInfoPayeeInfo.put("contactPhone",""); //联系人电话
        bodyMap.put("creditingInfoPayeeInfo",creditingInfoPayeeInfo);//若需要加密此字段则注释此行，不和encryptData同时存在

//        入账信息交易付款方信息	creditingInfoPayerInfo
        Map<String, String> creditingInfoPayerInfo = new HashMap<>();
        creditingInfoPayerInfo.put("acctBankNo","");//开户行行号
        creditingInfoPayerInfo.put("acctBankName","");//开户行名称
        creditingInfoPayerInfo.put("accNo",""); //账号
        creditingInfoPayerInfo.put("acctName",""); //账号名称
        creditingInfoPayerInfo.put("accType",""); //账号类型
        creditingInfoPayerInfo.put("businessLicenseRegNo",""); //统一社会信用代码
        creditingInfoPayerInfo.put("contactName",""); //联系人姓名
        creditingInfoPayerInfo.put("contactPhone",""); //联系人电话
        bodyMap.put("creditingInfoPayerInfo",creditingInfoPayerInfo);//若需要加密此字段则注释此行，不和encryptData同时存在


        Map<String, Object> encDataMap = new HashMap<>(); // 需要加密的敏感信息报文
        encDataMap.put("creditingInfoPayeeInfo", creditingInfoPayeeInfo);
        encDataMap.put("creditingInfoPayerInfo", creditingInfoPayerInfo);
