...
public class DemoPhoneNoQuery {
    private static final Logger logger = Logger.getLogger(DemoPhoneNoQuery.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.trade.phoneNo.query");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("regPhoneNo","");//转入方云闪付用户注册手机号
        bodyMap.put("regName","");//转入方云闪付用户姓名
