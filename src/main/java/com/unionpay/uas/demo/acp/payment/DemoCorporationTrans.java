...
public class DemoCorporationTrans {
    private static final Logger logger = Logger.getLogger(DemoCorporationTrans.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.corporation.trans");       // 交易类型 根据实际业务填写
        ...
        Map<String, String> payeeVerifyInfo = new HashMap<>();
        payeeVerifyInfo.put("accNo","");
        payeeVerifyInfo.put("customerNm","");
        payeeVerifyInfo.put("accType","");
        bodyMap.put("payeeVerifyInfo", Base64.encodeBase64String(JSONObject.wrap(payeeVerifyInfo).toString().getBytes(Charset.forName("UTF-8"))));//收款方信息域


        Map<String, String> creditInfo = new HashMap<>();
        creditInfo.put("payeeBankNo","");
        creditInfo.put("businessLicenseRegNo","");
        bodyMap.put("creditInfo",creditInfo);//贷记信息域

        Map<String, String> payerVerifyInfo = new HashMap<>();
        payerVerifyInfo.put("payerNm","");
        payerVerifyInfo.put("payerAccNo","");
//        payerVerifyInfo.put("payerAccNum","8554123654123");//与payerAccNo必送其一
        payerVerifyInfo.put("payerBusinessLicenseRegNo","");
        bodyMap.put("payerVerifyInfo", payerVerifyInfo);//付款方信息域



        // 需要加密的敏感信息报文 根据实际业务填写,商户入网配置敏感信息加密时使用如下注释代码
//        Map<String, String> payerVerifyInfoEncryptMap = new HashMap<>();
//        Map<String, String> payerVerifyInfoMap = (Map)bodyMap.get("payerVerifyInfo");
//        payerVerifyInfoEncryptMap.put("payerNm", payerVerifyInfoMap.remove("payerNm"));
//        payerVerifyInfoEncryptMap.put("payerAccNo", payerVerifyInfoMap.remove("payerAccNo"));
////        payerVerifyInfoEncryptMap.put("payerAccNum",payerVerifyInfoMap.remove("payerAccNum"));//付款方账号参与加密后，不再在敏文传递
//        Map<String, Object> encDataMap = new HashMap<>();
//        encDataMap.put("payeeVerifyInfo", bodyMap.remove("payeeVerifyInfo"));//明文中删除payeeVerifyInfo，并设置到待加密域中
//        encDataMap.put("payerVerifyInfo", payerVerifyInfoEncryptMap);
...
//        bodyMap.put(SDKConstants.param_encryptData, toBeEncMap); // 如果不需要携带敏感信息并由网关解密, 则注释这行代码
    ...
    public static void RsaDemo() {
        ...
        payerVerifyInfo.put("payerNm","");
        payerVerifyInfo.put("payerAccNo","");
//        payerVerifyInfo.put("payerAccNum","");//与payerAccNo必送其一
        payerVerifyInfo.put("payerBusinessLicenseRegNo","");
        bodyMap.put("payerVerifyInfo", payerVerifyInfo);//付款方信息域
