...
public class DemoBatchQuery {
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.trade.batch.query");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("batchType","");//批量交易类型;03：贷记;11：对公付款
        bodyMap.put("acqInsCode","");//收单机构代码
        bodyMap.put("batchNo","");//原交易批次号
        bodyMap.put("txnTime", DemoUtil.getTxnTime()); //原批量代收请求的交易时间
