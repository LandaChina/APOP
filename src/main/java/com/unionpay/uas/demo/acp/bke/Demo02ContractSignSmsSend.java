...
/**
 * 签约短信        bizMethod：upntAcp.contract.signSms.send
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class Demo02ContractSignSmsSend {

    private static final Logger logger = Logger.getLogger(Demo02ContractSignSmsSend.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.contract.signSms.send");       // 交易类型 根据实际业务填写
