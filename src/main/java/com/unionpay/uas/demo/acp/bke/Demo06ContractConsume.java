...
/**
 * 支付      bizMethod：upntAcp.contract.consume
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class Demo06ContractConsume {

    private static final Logger logger = Logger.getLogger(Demo06ContractConsume.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.contract.consume");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("contractScene", ""); //签约场景,默认不送：表示仅支付场景。取值01：表示签约并支付场景
        bodyMap.put("upProtocolVersion", ""); //银联协议版本号
        bodyMap.put("bankProtocolVersion", ""); //发卡协议版本号
        ...
        bodyMap.put("smallSumFlag", "");
        bodyMap.put("payAppId", ""); //当支付工具接入时，必送

        //组装风险控制信息信息域，仅提供组装方法的参考
        //bodyMap.put("riskRateInfo", buildRiskRateInfo());

        //组装基金信息域，需要根据实际进行填写字段
        //bodyMap.put("fundInfo", buildFundInfo());

        //组装分账域，需要根据实际进行填写字段,需整体做Base64编码，JSON格式
        //bodyMap.put("accSplitData", Base64.encodeBase64String(JSONObject.wrap(buildAccSplitData()).toString().getBytes()));

        bodyMap.put("customerIp", ""); //持卡人IP:填写持卡人发起交易的IP地址,可选
        ...
        //分期付款信息域	instalTransInfo
        //bodyMap.put("instalTransInfo", buildInstalTransInfo());
    ...
    public static void RsaDemo() {
        ...
        //Token信息域	tokenInfo
        //必送：trId
        //contractScene=01签约并支付场景，必送：tokenType；
        //仅支付场景时，必送：token；
        //contractScene=01签约并支付场景，根据token支付时，必送：token
        Map<String, Object> tokenInfoMap = new HashMap<>();
        tokenInfoMap.put("trId", ""); //标记请求者ID
        tokenInfoMap.put("tokenType", ""); //token类型
        tokenInfoMap.put("token", "");
    ...
    private static Map buildSubMerInfo(){
        ...
        subMerInfo.put("subMerCatCode", ""); //二级商户类别，选送
        return subMerInfo;
    }
...
//        riskRateInfo.put("shippingDistrictCode", "");
//        riskRateInfo.put("shippingStreet", "");
//        riskRateInfo.put("commodityCategory", "");
//        riskRateInfo.put("commodityName", "");
//        riskRateInfo.put("commodityUrl", "");
//        riskRateInfo.put("commodityUnitPrice", "");
//        riskRateInfo.put("commodityQty", "");
//        riskRateInfo.put("shippingMobile", "");
//        riskRateInfo.put("addressModifyTime", "");
//        riskRateInfo.put("userRegisterTime", "");
//        riskRateInfo.put("orderNameModifyTime", "");
//        riskRateInfo.put("userId", "");
//        riskRateInfo.put("orderName", "");
//        riskRateInfo.put("userFlag", "");
//        riskRateInfo.put("mobileModifyTime", "");
//        riskRateInfo.put("riskLevel", "");
//        riskRateInfo.put("merUserId", "");
//        riskRateInfo.put("merUserRegDt", "");
//        riskRateInfo.put("merUserEmail", "");
//        riskRateInfo.put("diskSep", "");
//        riskRateInfo.put("imei", "");
//        riskRateInfo.put("macAddr", "");
//        riskRateInfo.put("lbs", "");
//        riskRateInfo.put("deviceNumber", "");
//        riskRateInfo.put("deviceType", "");
//        riskRateInfo.put("captureMethod", "");
//        riskRateInfo.put("simCardCount", "");
//        riskRateInfo.put("deviceName", "");
//        riskRateInfo.put("deviceID", "");
//        riskRateInfo.put("mobile", "");
//        riskRateInfo.put("accountIdHash", "");
//        riskRateInfo.put("fullDeviceNumber", "");
//        riskRateInfo.put("sourceIP", "");
//        riskRateInfo.put("deviceLanguage", "");
//        riskRateInfo.put("accountEmailLife", "");
//        riskRateInfo.put("cardHolderName", "");
//        riskRateInfo.put("billingAddress", "");
//        riskRateInfo.put("billingZip", "");
//        riskRateInfo.put("riskScore", "");
//        riskRateInfo.put("riskStandardVersion", "");
//        riskRateInfo.put("deviceScore", "");
//        riskRateInfo.put("accountScore", "");
//        riskRateInfo.put("phoneNumberScore", "");
//        riskRateInfo.put("riskReasonCode", "");
//        riskRateInfo.put("applyChannel", "");
//        riskRateInfo.put("thirdPartyRiskScore", "");
//        riskRateInfo.put("thirdPartyDeviceId", "");
//        riskRateInfo.put("thirdPartyAdvise", "");
//        riskRateInfo.put("deviceMode", "");
//        riskRateInfo.put("safeCarrIss", "");
//        riskRateInfo.put("seId", "");
//        riskRateInfo.put("csn", "");
//        riskRateInfo.put("usrLoginMethod", "");
//        riskRateInfo.put("usrLoginTime", "");
//        riskRateInfo.put("usrLoginMessageTime", "");
//        riskRateInfo.put("usrLoginFaceTime", "");
//        riskRateInfo.put("usrLoginPasswordTime", "");
//        riskRateInfo.put("usrActivity", "");
//        riskRateInfo.put("usrFrequentAreaCode", "");
//        riskRateInfo.put("dfpSessionId", "");

        return riskRateInfo;
    }

    private static Map buildFundInfo(){
        Map<String, Object> subMerInfo = new HashMap<String, Object>();
        subMerInfo.put("fundComCode", ""); //基金销售公司代码,该代码由证监会向基金销售公司统一分配
        subMerInfo.put("fundProCode", ""); //基金产品代码,该代码由证监会发布编码规则，基金公司根据规则自行分配
        subMerInfo.put("fundProType", ""); //基金产品类型,0：股票型;1：债券型2：货币型;3：混合型;4：专户型;5：指数型 ;6：QDII ;7：FOF
        return subMerInfo;
    }

    private static Map buildAccSplitData(){
        Map<String, Object> accSplitData = new HashMap<String, Object>(); //接入类型为平台类接入时需上送
        accSplitData.put("accSplitType", ""); //分账类型
        accSplitData.put("accSplitRuleId", "");//分账规则ID
        //分账类型为1时才出现，accSplitMcht数组，最多支持5个分账对象accSplitMcht
        List<Map<String, Object>> accSplitMchtList = new ArrayList<>();
        Map<String, Object> accSplitMcht = new HashMap<String, Object>();
        accSplitMcht.put("accSplitMerId", "");
        accSplitMcht.put("accSplitAmt", "");
        accSplitMchtList.add(accSplitMcht);
        accSplitData.put("accSplitMchts", accSplitMchtList);
        return accSplitData;
    }
    ...
    private static Map buildInstalTransInfo() {
        Map<String, Object> instalTransInfoMap = new HashMap<String, Object>();
        instalTransInfoMap.put("numberOfInstallments", "");//分期付款期数
        instalTransInfoMap.put("instalRate", ""); //分期付款手续费率
        instalTransInfoMap.put("mchntFeeSubsidy", "");//商户补贴手续费率
        instalTransInfoMap.put("instalScene", ""); //分期场景
        instalTransInfoMap.put("protocolNo", ""); //分期协议流水号
        return instalTransInfoMap;
    }
}
