...
public class DemoQueryIn {
    private static final Logger logger = Logger.getLogger(DemoQueryIn.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.trade.query.in");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("orderId", ""); //原贷记类交易商户订单号
        bodyMap.put("txnTime", ""); //原贷记类交易时间
