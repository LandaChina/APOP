...
public class DemoTransfer {
    private static final Logger logger = Logger.getLogger(DemoTransfer.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.trade.transfer");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("accLegalInfo",accLegalInfo);
...
//        bodyMap.put("transferInTokenInfo", );
