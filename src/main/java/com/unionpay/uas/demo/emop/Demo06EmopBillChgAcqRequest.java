...
/**
 * 凭据变动申请（接入方发起）   bizMethod：upntCbs.emop.billChg.acqRequest
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class Demo06EmopBillChgAcqRequest {

    private static final Logger logger = Logger.getLogger(Demo06EmopBillChgAcqRequest.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntCbs.emop.billChg.acqRequest");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("billTokenId", ""); //凭据标记
        bodyMap.put("billChgType", ""); //凭据变更类型
        bodyMap.put("billChgAmount", ""); //凭据变动额度
        ...
        encDataMap.put("billOwnerCertifTp", ""); //凭据持有人证件类型
        encDataMap.put("billOwnerCertifId", ""); //凭据持有人证件号码
