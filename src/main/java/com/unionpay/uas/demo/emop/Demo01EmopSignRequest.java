...
/**
 * 签约申请       bizMethod：upntCbs.emop.sign.request
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class Demo01EmopSignRequest {

    private static final Logger logger = Logger.getLogger(Demo01EmopSignRequest.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntCbs.emop.sign.request");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("companyName", ""); //付款企业名称
        /*
         * 付款企业证件类型
         * 01：营业执照
         * 02：事业单位法人证书
        ...
        bodyMap.put("payerBankNm", ""); //付款方开户行名称
        bodyMap.put("payerBankNo", ""); //付款方开户行行号
        bodyMap.put("contractEffectDate", ""); //签约申请生效日期
        bodyMap.put("contractExprieDate", ""); //签约申请失效日期
        ...
        encDataMap.put("payerAcctNm", ""); //付款方账户名称
