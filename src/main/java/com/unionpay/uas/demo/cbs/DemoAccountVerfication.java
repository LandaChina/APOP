...
/**
 *  cbs 直连商户 demo- 账户验证
 *  本交易用于商户以账号、账户名称（或社会信用代码）
 *  送至账户机构进行账户和账户名称（或社会信用代码）的匹配性以及账户状态的判断，为对公支付业务前的进行辅助验证。
 */
public class DemoAccountVerfication {

    private static final Logger logger = Logger.getLogger(DemoAccountVerfication.class);
...
//        RsaDemo();
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "pay.b2b.000904");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("rcvAcctInfo",buildRcvAcctInfo());
        bodyMap.put("merName","测试商户");
        bodyMap.put("mcc","9999");
        bodyMap.put("epCertifType","01");
        bodyMap.put("epCertifNo","00001");
        bodyMap.put("countryCode","156");
        bodyMap.put("areaCode","1234");
        bodyMap.put("remark","我是remark我是remark");
        bodyMap.put("summary","我是summary我是summary");
    ...
    private static Map buildRcvAcctInfo(){
        HashMap<String,Object> rcvAcctInfo = new HashMap<>();
        rcvAcctInfo.put("bankNo","102100009997");
        rcvAcctInfo.put("acctNo","6222581234567897311212");
        rcvAcctInfo.put("acctName","张三测试机构机构机构");
        rcvAcctInfo.put("acctType","10");
        return rcvAcctInfo;
    }
