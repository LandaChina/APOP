...
/**
 *
 * cbs 直连商户 demo- 订单交易（批量）完成通知（异步应答）
 *
 银联处理完批量发送给的所有的订单后主动向商户发送本交易。
 *
 * 注意：
 * 统一接出网关的示例demo:
 ...
 */
public class DemoBatchOrderResultNotify {

    private static final Logger logger = Logger.getLogger(DemoBatchOrderResultNotify.class);
    ...
    public static void gm(){
        ...
        String respBodyStr ="{\"acqInsCode\":\"CBS12345\",\"txnNo\":\"123456789012345A0023544142\",\"txnDate\":\"20220706\",\"sndTime\":\"102323\",\"merId\":\"123456789012345\",\"origTxnDate\":\"20220706\",\"batchNo\":\"2311\",\"fileType\":\"01\",\"totalQty\":\"1\",\"succQty\":\"1\",\"code\":\"0000000000\",\"msg\":\"请求业务成功\",\"reqReserved\":{\"sampleKeyA\":\"A\",\"sampleKeyB\":\"B\"},\"reserved\":{\"sampleKeyA\":\"A\",\"sampleKeyB\":\"B\"}}";
        // 组装验签报文
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "pay.b2b.000122");       // 交易类型 根据实际业务填写
