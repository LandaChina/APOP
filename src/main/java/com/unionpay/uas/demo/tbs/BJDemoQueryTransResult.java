...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行不确定交易查询
 */
public class BJDemoQueryTransResult {

    private static final Logger logger = Logger.getLogger(BJDemoQueryTransResult.class);
    ...
    public static void gm(){
        ...
        bizMap.put("loanNo","20230306110359000000");
