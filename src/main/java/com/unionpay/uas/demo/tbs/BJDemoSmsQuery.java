...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行短信核验
 */
public class BJDemoSmsQuery {

    private static final Logger logger = Logger.getLogger(BJDemoSmsQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.query.smscode");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("bussTp","99");
        bizMap.put("contractId","C164032590079558278");
        bizMap.put("referenceNo","123456");
