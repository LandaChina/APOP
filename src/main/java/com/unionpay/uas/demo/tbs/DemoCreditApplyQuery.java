...
/**
 * TBS系统的模拟服务商接入示例demo-授信申请查询
 */
public class DemoCreditApplyQuery {

    private static final Logger logger = Logger.getLogger(DemoCreditApplyQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.credit.query.applyresult");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("applyNo","20220001162514");
        bizMap.put("protocolAcNo","221100017000100737");
        bizMap.put("orgReqSeq","20230216151053000000");
