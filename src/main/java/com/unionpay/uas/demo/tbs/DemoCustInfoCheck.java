...
/**
 * TBS系统的模拟服务商接入示例demo-客户信息检查
 */
public class DemoCustInfoCheck {

    private static final Logger logger = Logger.getLogger(DemoCustInfoCheck.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.cust.info.check");       // 交易类型 根据实际业务填写
