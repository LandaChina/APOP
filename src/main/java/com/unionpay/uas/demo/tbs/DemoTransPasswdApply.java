...
/**
 * TBS系统的模拟服务商接入示例demo-交易密码重置申请
 */
public class DemoTransPasswdApply {

    private static final Logger logger = Logger.getLogger(DemoTransPasswdApply.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.trans.passwd.apply");       // 交易类型 根据实际业务填写
