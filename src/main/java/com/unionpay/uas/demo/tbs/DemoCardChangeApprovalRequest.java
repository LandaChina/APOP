...
/**
 * TBS系统的模拟服务商接入示例demo-非零资产变更绑定卡申请发起
 */
public class DemoCardChangeApprovalRequest {

    private static final Logger logger = Logger.getLogger(DemoCardChangeApprovalRequest.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.card.change.approval.request");       // 交易类型 根据实际业务填写
        ...
        customInfo.put("holdImage", "data:image/jpg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD");
