...
/**
 * TBS系统的模拟服务商接入示例demo-手机号变更（原手机号可以收到短信）
 */
public class DemoPhoneChangeWithOld {

    private static final Logger logger = Logger.getLogger(DemoPhoneChangeWithOld.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.phone.change.with.old");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("newOrgSmscodeReqId","20230304212056000000");
