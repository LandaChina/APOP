...
/**
 * TBS系统的模拟服务商接入示例demo-出金到绑定卡
 */
public class DemoTransferOut {

    private static final Logger logger = Logger.getLogger(DemoTransferOut.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.transfer.out");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("amount","1000000");
        bizMap.put("payPath","0");
        bizMap.put("remark","直销银行转账");
        bizMap.put("token","123456");
        bizMap.put("largeAmountFlag","Y");
        bizMap.put("payMent","E");
        bizMap.put("cupAreaCode","1111");
        ...
        customInfo.put("subAccNo", "6216923700451180");
