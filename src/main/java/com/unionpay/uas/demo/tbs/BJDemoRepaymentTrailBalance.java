...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行还款试算
 */
public class BJDemoRepaymentTrailBalance {

    private static final Logger logger = Logger.getLogger(BJDemoRepaymentTrailBalance.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.repayment.trail.balance");       // 交易类型 根据实际业务填写
