...
/**
 * TBS系统的模拟服务商接入示例demo-变更绑定卡
 */
public class DemoCardChange {

    private static final Logger logger = Logger.getLogger(DemoCardChange.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.card.change");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("orgRandomReqId","20230304212032000000");
        bizMap.put("random","123456");
        bizMap.put("orgSmscodeReqId","20230304212056000000");
        ...
        customInfo.put("orgCardNumber", "6216923700451181");
