...
/**
 * TBS系统的模拟服务商接入示例demo-借款申请
 */
public class DemoLoanApply {

    private static final Logger logger = Logger.getLogger(DemoLoanApply.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.loan.apply");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("orgSmscodeReqId","20230216133746000000");

        bizMap.put("lmtNo","123");
        bizMap.put("loanPurpose","01");

        bizMap.put("drawnAmt","10000000");
        bizMap.put("cupAreaCode","1111");
        bizMap.put("intStartDt",DemoUtil.getTxnTime().substring(0,8));
        bizMap.put("repayType","3");
        bizMap.put("lastDueDt","20231201");
