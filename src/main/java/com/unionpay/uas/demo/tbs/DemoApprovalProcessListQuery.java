...
/**
 * TBS系统的模拟服务商接入示例demo-审批进度列表查询
 */
public class DemoApprovalProcessListQuery {

    private static final Logger logger = Logger.getLogger(DemoApprovalProcessListQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.approval.process.list.query");       // 交易类型 根据实际业务填写
