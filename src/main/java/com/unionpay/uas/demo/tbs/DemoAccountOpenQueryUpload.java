...
/**
 * TBS系统的模拟服务商接入示例demo-身份证上传结果查询
 */
public class DemoAccountOpenQueryUpload {

    private static final Logger logger = Logger.getLogger(DemoAccountOpenQueryUpload.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.open.query.upload");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("orgRequestId","20230304211921000000");
