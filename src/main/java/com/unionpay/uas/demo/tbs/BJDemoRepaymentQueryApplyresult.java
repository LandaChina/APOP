...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行还款结果查询
 */
public class BJDemoRepaymentQueryApplyresult {

    private static final Logger logger = Logger.getLogger(BJDemoRepaymentQueryApplyresult.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.repayment.query.applyresult");       // 交易类型 根据实际业务填写
