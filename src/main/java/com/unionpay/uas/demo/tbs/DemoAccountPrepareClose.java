...
/**
 * TBS系统的模拟服务商接入示例demo-电子账户预销户
 */
public class DemoAccountPrepareClose {

    private static final Logger logger = Logger.getLogger(DemoAccountPrepareClose.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.prepare.close");       // 交易类型 根据实际业务填写
