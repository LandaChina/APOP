...
/**
 * TBS系统的模拟服务商接入示例demo-手机号变更（原手机号不能收到短信）
 */
public class DemoPhoneChangeWithoutOld {

    private static final Logger logger = Logger.getLogger(DemoPhoneChangeWithoutOld.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.phone.change.without.old");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("newOrgSmscodeReqId","20230306095529000000");
        bizMap.put("newMsgCode","123456");
        bizMap.put("contractId","C164032590079558278");

        // 需要加密的敏感信息报文 根据实际业务填写
        Map<String, Object> customInfo = new HashMap<>();
        customInfo.put("subAccNo", "6216923700451180");
        customInfo.put("mobile", "17330000001");
