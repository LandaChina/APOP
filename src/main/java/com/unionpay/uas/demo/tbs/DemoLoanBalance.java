...
/**
 * TBS系统的模拟服务商接入示例demo-借款试算
 */
public class DemoLoanBalance {

    private static final Logger logger = Logger.getLogger(DemoLoanBalance.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.loan.balance");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("ccyCde","RMB");
        bizMap.put("drawnAmt","10000000");
        bizMap.put("intStartDt","20230501");
        bizMap.put("repayType","3");
        bizMap.put("tnr","12");
        bizMap.put("lastDueDt","20231201");
        bizMap.put("paymFreqNum","1");
        bizMap.put("paymFreqUnit","MTH");
        bizMap.put("fstPaymDt","20230502");
        bizMap.put("paymFreqNum","20231101");
