...
/**
 * TBS系统的模拟服务商接入示例demo-交易密码变更
 */
public class DemoTransPasswdChange {

    private static final Logger logger = Logger.getLogger(DemoTransPasswdChange.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.trans.passwd.change");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("newOrgRandomReqId","20230304212032000000");
        bizMap.put("newRandom","123456");
        ...
        customInfo.put("newPwdResult", "123456");
        customInfo.put("newPwdConfirm", "123456");
