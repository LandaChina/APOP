...
/**
 * TBS系统的模拟服务商接入示例demo-交易密码解锁
 */
public class DemoTransPasswdUnlock {

    private static final Logger logger = Logger.getLogger(DemoTransPasswdUnlock.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.trans.passwd.unlock");       // 交易类型 根据实际业务填写
