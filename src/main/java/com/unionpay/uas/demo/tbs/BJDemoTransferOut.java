...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行出金到绑定卡
 */
public class BJDemoTransferOut {

    private static final Logger logger = Logger.getLogger(BJDemoTransferOut.class);
    ...
    public static void gm(){
        ...
        bizMap.put("loanNo","20230306095206000000");
