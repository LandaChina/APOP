...
/**
 * TBS系统的模拟服务商接入示例demo-身份证上传
 */
public class DemoAccountOpenUpload {

    private static final Logger logger = Logger.getLogger(DemoAccountOpenUpload.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.open.upload");       // 交易类型 根据实际业务填写
