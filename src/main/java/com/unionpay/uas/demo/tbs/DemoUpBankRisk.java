...
/**
 * TBS系统的模拟服务商接入示例demo-贷后商户核验
 */
public class DemoUpBankRisk {

    private static final Logger logger = Logger.getLogger(DemoUpBankRisk.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.up.bank.risk");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("tranStartDate","20230101");
        bizMap.put("tranEndDate","20230201");
