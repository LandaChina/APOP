...
/**
 * TBS系统的模拟服务商接入示例demo-营业执照OCR
 */
public class DemoOcrBusslisence {

    private static final Logger logger = Logger.getLogger(DemoOcrBusslisence.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.precredit.ocr.busslicence");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("image","data:image/jpg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD");
