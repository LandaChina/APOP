...
/**
 * TBS系统的模拟服务商接入示例demo-电子账户销户
 */
public class DemoAccountCloseResultQuery {

    private static final Logger logger = Logger.getLogger(DemoAccountCloseResultQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.close.result.query");       // 交易类型 根据实际业务填写
