...
/**
 * TBS系统的模拟服务商接入示例demo-借款发放结果查询
 */
public class DemoLoanQueryApply {

    private static final Logger logger = Logger.getLogger(DemoLoanQueryApply.class);
    ...
    public static void gm(){
        ...
        bizMap.put("orgReqSeq","20230216160206000000");
