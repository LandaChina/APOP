...
/**
 * TBS系统的模拟服务商接入示例demo-借记卡信息查询
 */
public class DemoprecrditQueryCardinfo {

    private static final Logger logger = Logger.getLogger(DemoprecrditQueryCardinfo.class);
    ...
    public static void gm(){
        ...
        customInfo.put("cardNumber", "6212121234567890");
