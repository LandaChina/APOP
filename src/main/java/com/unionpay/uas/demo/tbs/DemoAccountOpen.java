...
/**
 * TBS系统的模拟服务商接入示例demo-开户
 */
public class DemoAccountOpen {

    private static final Logger logger = Logger.getLogger(DemoAccountOpen.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.open");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("msgCode","123456");
        bizMap.put("agreeProtocol","0");
        bizMap.put("company","上海公安局");
        bizMap.put("resChnTax","Y");
        bizMap.put("cupAreaCode","0099");
        bizMap.put("nationality","中国");
        bizMap.put("occupation","刑警");
        bizMap.put("address","上海市浦东新区");
        bizMap.put("postCode","223399");
        bizMap.put("validStart","20220101");
        bizMap.put("validUntil","99999999");
        bizMap.put("occRemark","1");

        bizMap.put("orgRandomReqId","20230306095206000000");
        bizMap.put("random","123456");
        bizMap.put("orgSmscodeReqId","20230306095529000000");
        bizMap.put("orgUploadReqId","20230306095630000000");

        bizMap.put("area","223311");
        ...
        customInfo.put("pwdConfirm", "123456");
