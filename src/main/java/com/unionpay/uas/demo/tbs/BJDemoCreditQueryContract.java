...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行合同模板详细信息查询
 */
public class BJDemoCreditQueryContract {

    private static final Logger logger = Logger.getLogger(BJDemoCreditQueryContract.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.credit.query.contract");       // 交易类型 根据实际业务填写
