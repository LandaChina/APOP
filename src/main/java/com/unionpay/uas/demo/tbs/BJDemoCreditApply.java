...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行授信申请
 */
public class BJDemoCreditApply {

    private static final Logger logger = Logger.getLogger(BJDemoCreditApply.class);
    ...
    public static void gm(){
        ...
        bizMap.put("sccImage","data:image/jpg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD");
        bizMap.put("sccName","小店");
        bizMap.put("shopName","小店");
        bizMap.put("address","顾塘路");
        bizMap.put("authorizeCd","1");
        bizMap.put("frontUrl", "www.baidu.com");
        ...
        bodyMap.put("issInsCode","BCCB0001");
