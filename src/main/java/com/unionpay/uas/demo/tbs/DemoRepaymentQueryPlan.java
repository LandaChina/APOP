...
/**
 * TBS系统的模拟服务商接入示例demo-还款计划查询
 */
public class DemoRepaymentQueryPlan {

    private static final Logger logger = Logger.getLogger(DemoRepaymentQueryPlan.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.repayment.query.plan");       // 交易类型 根据实际业务填写
