...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行授信申请查询
 */
public class BJDemoCreditApplyQuery {

    private static final Logger logger = Logger.getLogger(BJDemoCreditApplyQuery.class);
