...
public class DemoTransferIn {
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.transfer.in");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("remittee","E");
        bizMap.put("subscribeummary","烟草贷");
