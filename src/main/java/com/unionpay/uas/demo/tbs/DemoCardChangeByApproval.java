...
/**
 * TBS系统的模拟服务商接入示例demo-根据审核结果变更绑定卡
 */
public class DemoCardChangeByApproval {

    private static final Logger logger = Logger.getLogger(DemoCardChangeByApproval.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.card.change.by.approval");       // 交易类型 根据实际业务填写
