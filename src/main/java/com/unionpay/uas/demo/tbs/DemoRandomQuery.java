...
/**
 * TBS系统的模拟服务商接入示例demo-随机数查询
 */
public class DemoRandomQuery {

    private static final Logger logger = Logger.getLogger(DemoRandomQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.query.random");       // 交易类型 根据实际业务填写
