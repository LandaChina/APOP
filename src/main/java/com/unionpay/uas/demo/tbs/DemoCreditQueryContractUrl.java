...
/**
 * TBS系统的模拟服务商接入示例demo-获取合同签约h5链接
 */
public class DemoCreditQueryContractUrl {

    private static final Logger logger = Logger.getLogger(DemoCreditQueryContractUrl.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.credit.query.contract.url");       // 交易类型 根据实际业务填写
