...
/**
 * TBS系统的模拟服务商接入示例demo-客户信息完善
 */
public class DemoCustInfoMaintain {

    private static final Logger logger = Logger.getLogger(DemoCustInfoMaintain.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.cust.info.maintain");       // 交易类型 根据实际业务填写
