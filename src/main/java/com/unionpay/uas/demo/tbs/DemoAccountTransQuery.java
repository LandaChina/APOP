...
/**
 * TBS系统的模拟服务商接入示例demo-电子账户交易明细查询
 */
public class DemoAccountTransQuery {

    private static final Logger logger = Logger.getLogger(DemoAccountTransQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.trans.query");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("beginDate","20220101");
        bizMap.put("endDate","20230101");
        bizMap.put("beginNumber","1");
        bizMap.put("queryNumber","10");

        bizMap.put("sortType","A");
