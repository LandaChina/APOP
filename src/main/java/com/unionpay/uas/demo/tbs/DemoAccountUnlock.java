...
/**
 * TBS系统的模拟服务商接入示例demo-电子账户解锁
 */
public class DemoAccountUnlock {

    private static final Logger logger = Logger.getLogger(DemoAccountUnlock.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.unlock");       // 交易类型 根据实际业务填写
