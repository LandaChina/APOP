...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行合同确认
 */
public class BJDemoCreditConfirmContract {

    private static final Logger logger = Logger.getLogger(BJDemoCreditConfirmContract.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.credit.confirm.contract");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("origBizMethod","soluTbs.credit.apply");
        bizMap.put("applyNo","LN2600202200248159");
        bizMap.put("approval","Y");
        bizMap.put("fileSeqNo","20230301194845000000");
