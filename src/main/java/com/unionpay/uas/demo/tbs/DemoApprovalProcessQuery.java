...
/**
 * TBS系统的模拟服务商接入示例demo-审批进度查询
 */
public class DemoApprovalProcessQuery {

    private static final Logger logger = Logger.getLogger(DemoApprovalProcessQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.approval.process.query");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("orgRequestId","20230306102320000000");
