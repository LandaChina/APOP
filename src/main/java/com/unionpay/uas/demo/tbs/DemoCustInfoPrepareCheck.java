...
/**
 * TBS系统的模拟服务商接入示例demo-反洗钱三要素信息预校验
 */
public class DemoCustInfoPrepareCheck {

    private static final Logger logger = Logger.getLogger(DemoCustInfoPrepareCheck.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.cust.info.prepare.check");       // 交易类型 根据实际业务填写
