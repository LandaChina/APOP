...
/**
 * TBS系统的模拟服务商接入示例demo-入金汇路查询
 */
public class DemoTransferQueryRouterIn {

    private static final Logger logger = Logger.getLogger(DemoTransferQueryRouterIn.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.transfer.query.router.in");       // 交易类型 根据实际业务填写
