...
/**
 * TBS系统的模拟服务商接入示例demo-电子账户密码验证
 */
public class DemoAccountPasswdValidate {

    private static final Logger logger = Logger.getLogger(DemoAccountPasswdValidate.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.passwd.validate");       // 交易类型 根据实际业务填写
