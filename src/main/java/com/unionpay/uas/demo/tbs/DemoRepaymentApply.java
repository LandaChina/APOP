...
/**
 * TBS系统的模拟服务商接入示例demo-还款申请
 */
public class DemoRepaymentApply {

    private static final Logger logger = Logger.getLogger(DemoRepaymentApply.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.repayment.apply");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("settleMode","Z");
        bizMap.put("loanNo","LN2600202200248159");
        bizMap.put("settleDate","20231231");
        bizMap.put("settleAmt","1000000");
