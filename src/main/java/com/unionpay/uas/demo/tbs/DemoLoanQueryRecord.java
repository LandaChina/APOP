...
/**
 * TBS系统的模拟服务商接入示例demo-借款列表查询
 */
public class DemoLoanQueryRecord {

    private static final Logger logger = Logger.getLogger(DemoLoanQueryRecord.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.loan.query.record");       // 交易类型 根据实际业务填写
