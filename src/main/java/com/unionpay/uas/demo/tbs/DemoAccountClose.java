 ...
 */
public class DemoAccountClose {

    private static final Logger logger = Logger.getLogger(DemoAccountClose.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.close");       // 交易类型 根据实际业务填写
