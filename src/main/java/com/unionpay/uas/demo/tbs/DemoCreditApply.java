...
/**
 * TBS系统的模拟服务商接入示例demo-授信申请
 */
public class DemoCreditApply {

    private static final Logger logger = Logger.getLogger(DemoCreditApply.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.credit.apply");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("protocolAcNo","221100017000100737");
        bizMap.put("orgRandomReqId","20230216133826000000");
        bizMap.put("random","12345acd90123456");
        bizMap.put("maritalStatus","1");
        bizMap.put("province","上海市");
        bizMap.put("city","上海市");
        bizMap.put("zone","浦东新区");
        bizMap.put("contactAddr","中国银联");
        bizMap.put("projNo","");
        bizMap.put("validStart","20220101");
        bizMap.put("validUntil","99999999");
        bizMap.put("tobaccoLicenseExpireDate","9999-01-01");
        bizMap.put("tobaccoGrade","100");
        bizMap.put("tobaccoLicense","105312200012");
        bizMap.put("scc","911101022025226633");
        bizMap.put("shopName","公安局");
        bizMap.put("educationLevel","1");
        bizMap.put("authorizeCd","1");
        bizMap.put("isLocalResidence","Y");
        bizMap.put("customTotalAsset","10000000000");

        bizMap.put("customAssetVal","200000000000");
        bizMap.put("validEnd","2000");

        bizMap.put("cupAreaCode","1000");
        bizMap.put("contractId","C164032590079558278");

        // 需要加密的敏感信息报文 根据实际业务填写
        Map<String, Object> customInfo = new HashMap<>();
        customInfo.put("name", "史强");
        customInfo.put("idNo", "320666198012011733");
        customInfo.put("idType", "01");
        customInfo.put("mobile", "13801230123");

        customInfo.put("emergName", "史小强");
        customInfo.put("emergContactType", "03");
        customInfo.put("emergMobile", "13801230124");
        customInfo.put("corporator", "史强");
        customInfo.put("spouseIdNo", "320666198012011734");
        customInfo.put("spouseIdType", "01");
        customInfo.put("spouseMobile", "13801230125");
        ...
        customInfo.put("invalidDate", "21000101");
        customInfo.put("cardNumber", "6219123456789012345");
        customInfo.put("pwdResult", "123456");
        ...
        bodyMap.put("transDate","20221101");
