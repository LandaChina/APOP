...
/**
 * TBS系统的模拟服务商接入示例demo-电子账户信息查询
 */
public class DemoAccountQueryEacountDetail {

    private static final Logger logger = Logger.getLogger(DemoAccountQueryEacountDetail.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.query.eaccount.detail");       // 交易类型 根据实际业务填写
