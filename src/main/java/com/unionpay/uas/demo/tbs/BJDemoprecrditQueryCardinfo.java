...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行借记卡信息查询
 */
public class BJDemoprecrditQueryCardinfo {

    private static final Logger logger = Logger.getLogger(BJDemoprecrditQueryCardinfo.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.precredit.query.cardinfo");       // 交易类型 根据实际业务填写
