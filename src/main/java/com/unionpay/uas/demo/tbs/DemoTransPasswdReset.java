...
/**
 * TBS系统的模拟服务商接入示例demo-交易密码重置
 */
public class DemoTransPasswdReset {

    private static final Logger logger = Logger.getLogger(DemoTransPasswdReset.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.trans.passwd.reset");       // 交易类型 根据实际业务填写
