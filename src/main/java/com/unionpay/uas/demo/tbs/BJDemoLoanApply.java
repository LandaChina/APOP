...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行借款申请
 */
public class BJDemoLoanApply {

    private static final Logger logger = Logger.getLogger(BJDemoLoanApply.class);
