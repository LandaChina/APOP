...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行额度详细信息查询
 */
public class BJDemoCreditapplydetail {

    private static final Logger logger = Logger.getLogger(BJDemoCreditapplydetail.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.credit.apply.detail");       // 交易类型 根据实际业务填写
