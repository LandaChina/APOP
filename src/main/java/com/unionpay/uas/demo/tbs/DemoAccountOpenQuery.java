...
/**
 * TBS系统的模拟服务商接入示例demo-开户结果查询
 */
public class DemoAccountOpenQuery {

    private static final Logger logger = Logger.getLogger(DemoAccountOpenQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.query.openresult");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("openSeriNo","20230306105315000000");
