 ...
 */
public class BJDemoCreditBankQuery {

    private static final Logger logger = Logger.getLogger(BJDemoCreditBankQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.credit.bank.query.applyresult");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("applyNo","6171192954");
        bizMap.put("orgReqSeq","20231130143413000000");
