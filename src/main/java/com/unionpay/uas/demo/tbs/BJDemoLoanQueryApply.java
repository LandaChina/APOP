...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行借款发放结果查询
 */
public class BJDemoLoanQueryApply {

    private static final Logger logger = Logger.getLogger(BJDemoLoanQueryApply.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.loan.query.apply");       // 交易类型 根据实际业务填写
