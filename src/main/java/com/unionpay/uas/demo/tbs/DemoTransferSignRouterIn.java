...
/**
 * TBS系统的模拟服务商接入示例demo-入金通道签约
 */
public class DemoTransferSignRouterIn {

    private static final Logger logger = Logger.getLogger(DemoTransferSignRouterIn.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.transfer.sign.router.in");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("bankInnerPath","20");

        bizMap.put("orgSmscodeReqId","20230304212032000000");
