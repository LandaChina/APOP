...
/**
 * TBS系统的模拟服务商接入示例demo-单笔借款查询
 */
public class DemoLoanQueryDetail {

    private static final Logger logger = Logger.getLogger(DemoLoanQueryDetail.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.loan.query.detail");       // 交易类型 根据实际业务填写
