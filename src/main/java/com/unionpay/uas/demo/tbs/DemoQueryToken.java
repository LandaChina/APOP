...
/**
 * TBS系统的模拟服务商接入示例demo-token申请
 */
public class DemoQueryToken {

    private static final Logger logger = Logger.getLogger(DemoQueryToken.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.query.token");       // 交易类型 根据实际业务填写
