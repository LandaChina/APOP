...
/**
 * TBS系统的模拟服务商接入示例demo-还款历史查询
 */
public class DemoRepaymentQueryHistory {

    private static final Logger logger = Logger.getLogger(DemoRepaymentQueryHistory.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.repayment.query.history");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("pageNo","1");
        bizMap.put("pageNum","12");
        bizMap.put("tranStartDate","20230501");
        bizMap.put("tranEndDate","20230901");
