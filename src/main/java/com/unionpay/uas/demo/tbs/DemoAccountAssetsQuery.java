...
/**
 * TBS系统的模拟服务商接入示例demo-电子账户资产信息查询
 */
public class DemoAccountAssetsQuery {

    private static final Logger logger = Logger.getLogger(DemoAccountAssetsQuery.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.account.assets.query");       // 交易类型 根据实际业务填写
