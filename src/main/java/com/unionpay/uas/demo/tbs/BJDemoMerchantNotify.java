...
/**
 * TBS系统的模拟服务商接入示例demo-北京银行订单支付结果通知
 */
public class BJDemoMerchantNotify {

    private static final Logger logger = Logger.getLogger(BJDemoMerchantNotify.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.merchant.notify");       // 交易类型 根据实际业务填写
        ...
        bizMap.put("thirdMerOrder","1234567890");
        bizMap.put("loanNo","LN2600202200248159");
        bizMap.put("tobaccoGrade","100");
        bizMap.put("tobaccoLicense","105312200012");
        bizMap.put("contractId","C164032590079558278");
        bizMap.put("payAmt","100");
        bizMap.put("cupAreaCode","1111");
        bizMap.put("drawnAmt","10000");
        bizMap.put("protocolAcNo","11111111");
        bizMap.put("tradeResult","F");
        bizMap.put("thirdOrderType","01");
        bizMap.put("thirdOrderNo","1111");
