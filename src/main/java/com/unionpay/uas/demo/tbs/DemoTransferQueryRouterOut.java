...
/**
 * TBS系统的模拟服务商接入示例demo-出金汇路查询
 */
public class DemoTransferQueryRouterOut {

    private static final Logger logger = Logger.getLogger(DemoTransferQueryRouterOut.class);
    ...
    public static void gm(){
        ...
        reqData.put(SDKConstants.param_bizMethod, "soluTbs.transfer.query.router.out");       // 交易类型 根据实际业务填写
