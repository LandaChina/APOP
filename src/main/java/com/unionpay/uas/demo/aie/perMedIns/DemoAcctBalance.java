...
public class DemoAcctBalance {
    private static final Logger logger = Logger.getLogger(DemoAcctBalance.class);
    ...
    public static void GmDemo(){
        ...
        reqHeader.put(SDKConstants.param_bizMethod, "openAccount.medAcc.acctBalance");       // 交易类型 根据实际业务填写
...
//        reqBodyMap.put("certifId","123456789123456789");
        ...
        reqBodyMap.put("currCd","01");
        reqBodyMap.put("queryTp","01");
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "openAccount.medAcc.acctBalance");       // 交易类型 根据实际业务填写
...
//        bodyMap.put("medInsAccountNo", "15474221135487");
        bodyMap.put("availableBalance", "15321");
        bodyMap.put("intAmt", "541");
        bodyMap.put("medInsAccStatus", "01");
