 ...
 * 模拟移企付业务签约通知接口
 */
public class DemoSignResult {

    private static final Logger logger = Logger.getLogger(DemoSignResult.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAie.emop.sign.result");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("acctInsCode", "act0001");
        bodyMap.put("txnDate", "20241001");
        bodyMap.put("txnNo", "UPSIMNo2024101115000089521201");
        bodyMap.put("sndTime", "155335");
        bodyMap.put("contractStatus", "00");
        bodyMap.put("contractDate", "20241001");
        bodyMap.put("contractNo", "ctn123456789");
        bodyMap.put("trId", "shoulipingtaiid");

        // 需要加密的敏感信息报文 根据实际业务填写
        Map<String, Object> encDataMap = new HashMap<>();
        encDataMap.put("payerAcctNo", "1474224841");
