...
public class DemoFundsTransfer {
    private static final Logger logger = Logger.getLogger(DemoFundsTransfer.class);
    ...
    public static void GmDemo(){
        ...
        reqHeader.put(SDKConstants.param_bizMethod, "openAccount.medAcc.fundsTransfer");       // 交易类型 根据实际业务填写
...
//        reqBodyMap.put("receiveAcct","621457424498742");

        reqBodyMap.put("transAmt","15554741");
        reqBodyMap.put("receiveAcct","621457424498742");
        reqBodyMap.put("mchntCd","145236987451254");
        reqBodyMap.put("mchntOrderNo","orderNo123456789");
        reqBodyMap.put("certifTp","01");
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "openAccount.medAcc.fundsTransfer");       // 交易类型 根据实际业务填写
        ...
        encDataMap.put("availableBalance", "15321");
        encDataMap.put("transAmt", "541");
