 ...
 */
public class DemocMqrPurchase {

    private static final Logger logger = Logger.getLogger(DemocMqrPurchase.class);
    ...
    public static void gm(Map<String, String> reqHeader, String reqBodyStr) {
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntQrc.accMqr.purchase");       // 交易类型 根据实际业务填写
    ...
    private static Map buildTransparentData(){
        ...
        transparentData.put("appToIssResv","value6");
        transparentData.put("issToAppResv","value7");
