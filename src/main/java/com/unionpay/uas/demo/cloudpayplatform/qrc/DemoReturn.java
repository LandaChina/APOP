...
/**
 * 云闪付网络支付平台-被扫/主扫消费退货(付款方) 移动应用前置模式
...
public class DemoReturn {
    ...
    private static final Logger logger = Logger.getLogger(DemoReturn.class);
    ...
    public static void gm(Map<String, String> reqHeader, String reqBodyStr) {
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntQrc.accCqr.return");       // 交易类型 根据实际业务填写,upntQrc.accCqr.return（被扫）或upntQrc.accMqr.return（主扫）
