 ...
 */
public class DemoQuickBindCard {

    private static final Logger logger = Logger.getLogger(DemoQuickBindCard.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "cusrCqpos.card.quickBindCard");       // 交易类型 根据实际业务填写
        ...
        encDataMap.put("userAccInfo", userAccInfo);
        encDataMap.put("areaCode", "0000");
        encDataMap.put("channelType", "h");
        encDataMap.put("bindOpr", "1"); // 1-绑卡（不送时默认），2-注销卡通知解绑
