...
public class DemoTxnPost {
    ...
    public static void gm(Map<String, String> reqHeader, String reqBodyStr) {
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntAcp.accOnl.txnPost");       // 交易类型 根据实际业务填写
        resData.put(SDKConstants.param_version, "7.1.0");                // 版本号 根据实际业务填写
