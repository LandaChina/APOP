 ...
 */
public class DemocCqrReversal {

    private static final Logger logger = Logger.getLogger(DemocCqrReversal.class);
    ...
    public static void gm(Map<String, String> reqHeader, String reqBodyStr) {
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntQrc.accCqr.reversal");       // 交易类型 根据实际业务填写
