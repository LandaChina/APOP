 ...
 */
public class DemoFindUser {

    private static final Logger logger = Logger.getLogger(DemoFindUser.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "cusrCqpos.user.findUser");       // 交易类型 根据实际业务填写
