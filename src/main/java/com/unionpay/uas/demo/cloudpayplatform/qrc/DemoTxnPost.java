...
/**
 * 云闪付网络支付平台-扫码交易通知(付款方) 银行卡前置模式
 */
public class DemoTxnPost {

    private static final Logger logger = Logger.getLogger(DemoTxnPost.class);
    ...
    public static void gm(Map<String, String> reqHeader, String reqBodyStr) {
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntQrc.accQr.txnPost");       // 交易类型 根据实际业务填写
