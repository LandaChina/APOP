 ...
 */
public class DemoUnBindUser {

    private static final Logger logger = Logger.getLogger(DemoUnBindUser.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "cusrCqpos.user.unBindUser");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("unbindCardsFlg", "1"); // 0-不解绑，1-全部解绑（不上送默认为1）
