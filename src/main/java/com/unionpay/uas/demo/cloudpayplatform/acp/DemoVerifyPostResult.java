package com.unionpay.uas.demo.cloudpayplatform.acp;
...
public class DemoVerifyPostResult {
    ...
    public static void GmDemo() {
        ...
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.verify.postResult");       //根据前序“交易验证策略查询”交易中的“二维码交易场景（qrScene）”字段取值不同而定：如qrScene = 03，取值：upntAcp.verify.postResult;其余情况下，取值：upntQrc.verify.postResult
        ...
        bodyMap.put("reqReserved", "");//请求保留域,整体进行Base64编码,将交易验证策略查询接口中该字段原样返回
