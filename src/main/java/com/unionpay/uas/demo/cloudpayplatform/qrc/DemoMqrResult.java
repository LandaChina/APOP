...
/**
 * 云闪付网络支付平台-主扫收款通知(收款方)
 */
public class DemoMqrResult {

    private static final Logger logger = Logger.getLogger(DemoMqrResult.class);
    ...
    public static void gm(Map<String, String> reqHeader, String reqBodyStr) {
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntQrc.acqMqr.result");       // 交易类型 根据实际业务填写
