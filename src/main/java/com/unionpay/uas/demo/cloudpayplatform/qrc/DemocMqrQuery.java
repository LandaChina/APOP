 ...
 */
public class DemocMqrQuery {

    private static final Logger logger = Logger.getLogger(DemocMqrQuery.class);
    ...
    public static void gm(Map<String, String> reqHeader, String reqBodyStr) {
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntQrc.accMqr.query");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("origCode", "Value5");
        bodyMap.put("origMsg", "Value6");
        bodyMap.put("origSubCode", "Value7");
        bodyMap.put("origSubMsg", "Value8");
        bodyMap.put("bankOffAmt", "Value9");//银行实际承兑金额
