 ...
 */
public class DemoPaymentnoticeReceipt {

    private static final Logger logger = Logger.getLogger(DemoPaymentnoticeReceipt.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntMaps.paymentnotice.receipt");       // 交易类型 根据实际业务填写
        ...
        Info.put("pdfStr", "*************************");//银行签章内容
        Info.put("yhlspdfStr", "*************************");//银行扣款流水凭证
        Info.put("kkztDm", "01");//扣款状态
        Info.put("kkfhxx", "*************************");//扣款返回信息
        //将reqInfo塞入报文体
