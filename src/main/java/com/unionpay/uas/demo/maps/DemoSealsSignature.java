 ...
 */
public class DemoSealsSignature {

    private static final Logger logger = Logger.getLogger(DemoSealsSignature.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntMaps.seal.signature");       // 交易类型 根据实际业务填写
        ...
        Info.put("sbh", "0100000000000000000");//纳税人识别号
        Info.put("positions", "*************************");//签章坐标
        Info.put("sealType", "11");//印章类型
        Info.put("username", "*************************");//签章账号
        Info.put("keyType", "1");//签章类型
        Info.put("opacity", "1");//透明度
        Info.put("qzms", "0");//签章模式
        //将reqInfo塞入报文体
