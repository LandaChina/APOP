 ...
 */
public class DemoPaymentnoticePush {

    private static final Logger logger = Logger.getLogger(DemoPaymentnoticePush.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP应答报文头
        resData.put(SDKConstants.param_bizMethod, "upntMaps.paymentnotice.push");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("code", "00000000000");//应答码
        bodyMap.put("msg", "成功");//应答码描述
        bodyMap.put("subCode", "选填");//详细应答码
        bodyMap.put("subMsg", "选填");//详细应答码描述
        bodyMap.put("mchntCd", "同请求");//税局商户代码
        bodyMap.put("txnTime", "同请求");//交易发送时间
        bodyMap.put("orderId", "同请求");//订单号
        bodyMap.put("respInfo", "银行信息字段，选送，银联会透传给税局");//银行信息域
        bodyMap.put("resv", "选填");//应答保留域
