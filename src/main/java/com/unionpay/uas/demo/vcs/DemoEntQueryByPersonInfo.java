...
/**
 * 企业信息查询-基于人员信息,支持四要素验证或三要素验证。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoEntQueryByPersonInfo {

    private static final Logger logger = Logger.getLogger(DemoEntQueryByPersonInfo.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("mask", "bodyValue1");
        bodyMap.put("perName", "bodyValue1");
