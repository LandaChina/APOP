...
/**
 * 企业信息查询-照面,根据企业标识（统一社会信用代码/工商注册号/企业全称/组织机构代码），
 * 查询企业基础信息、变更信息、严重违法、对外投资信息、异常名录、分支机构、清算信息、动产抵押、主要管理人员、股东及出资信息、股权出质信息、年报等。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoEntQueryByEntMark {

    private static final Logger logger = Logger.getLogger(DemoEntQueryByEntMark.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("creditCode", "bodyValue1");
        bodyMap.put("bussRegNo", "bodyValue1");
        bodyMap.put("entName", "bodyValue1");
        bodyMap.put("orgCd", "bodyValue1");
        bodyMap.put("entStatus", "bodyValue1");
        bodyMap.put("entTypeCode", "bodyValue1");
