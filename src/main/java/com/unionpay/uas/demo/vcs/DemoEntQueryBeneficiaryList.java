...
/**
 * 企业最终受益人查询-基于企业标识（统一社会信用代码/工商注册号/企业全称），查询返回企业的受益人所有信息。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoEntQueryBeneficiaryList {

    private static final Logger logger = Logger.getLogger(DemoEntQueryBeneficiaryList.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("entMark", "bodyValue2");
