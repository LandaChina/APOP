...
/**
 * 企业信息验证,支持四要素验证或三要素验证。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoEntVerify {

    private static final Logger logger = Logger.getLogger(DemoEntVerify.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("txnType", "bodyValue3");//8301-四要素验证   8302-三要素验证
        ...
        Map<String, String> entVerifyInfoMap = new HashMap<>();
        entVerifyInfoMap.put("creditCode", "bodyValue1");
        entVerifyInfoMap.put("entName", "bodyValue1");
        entVerifyInfoMap.put("dom", "bodyValue1");
        entVerifyInfoMap.put("legalRepNm", "bodyValue1");

        bodyMap.put("entVerifyInfo", entVerifyInfoMap);
