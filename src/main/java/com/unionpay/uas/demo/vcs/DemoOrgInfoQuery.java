...
/**
 * 组织机构信息查询,根据企业标识（组织机构代码/组织机构全称/统一社会信用代码/工商注册号），查询组织机构信息。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoOrgInfoQuery {

    private static final Logger logger = Logger.getLogger(DemoOrgInfoQuery.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("orgName", "bodyValue1");
