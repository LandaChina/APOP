...
/**
 * 小微企业识别,使用企业标识字段查询判定是否为小微企业。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoIsMicroEnt {

    private static final Logger logger = Logger.getLogger(DemoIsMicroEnt.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("entAttr", "bodyValue1");
