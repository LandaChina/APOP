...
/**
 * 企业信息变更订阅,根据企业名称、社会注册号或信用代码订阅企业信息，使用企业名称订阅时若存在多家重名企业，则该企业订阅失败，建议优先使用信用代码进行订阅。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoEntSubs {

    private static final Logger logger = Logger.getLogger(DemoEntSubs.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("entAttrType", "bodyValue1");
        bodyMap.put("reqReserved", "bodyValue3");

        List<String> entAttrList = new ArrayList<>();
        entAttrList.add("bodyValue1");//取值元素与企业关键字类型对应，元素个数上限为20。
        bodyMap.put("entAttrList",entAttrList);
