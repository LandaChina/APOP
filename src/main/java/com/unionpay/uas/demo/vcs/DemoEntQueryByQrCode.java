...
/**
 * 纸质营业执照二维码查询,根据营业执照上的二维码内容，查询企业信息。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoEntQueryByQrCode {

    private static final Logger logger = Logger.getLogger(DemoEntQueryByQrCode.class);
    ...
    public static void gm() {
        ...
        bodyMap.put("qrCodeContent", "bodyValue1");
