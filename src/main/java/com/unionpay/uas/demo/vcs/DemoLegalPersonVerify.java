package com.unionpay.uas.demo.vcs;
...
/**
 * 企业法人信息验证,支持四要素验证或三要素验证。
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoLegalPersonVerify {

    private static final Logger logger = Logger.getLogger(DemoLegalPersonVerify.class);
    ...
    public static void gm() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntVcs.verify.enterprise");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("encoding", "UTF-8");
        bodyMap.put("txnType", "bodyValue3");//8303-四要素验证 8304-三要素验证
        bodyMap.put("accessType", "bodyValue1");
        bodyMap.put("appCode", "bodyValue2");
        bodyMap.put("acqInsCode", "bodyValue3");
        bodyMap.put("merId", "bodyValue1");
        bodyMap.put("merName", "bodyValue2");
        bodyMap.put("merCatCode", "bodyValue3");
        bodyMap.put("orderId", "bodyValue1");
        bodyMap.put("txnTime", "bodyValue3");
        bodyMap.put("remark", "bodyValue2");
        bodyMap.put("reqReserved", "bodyValue3");
        bodyMap.put("reserved", "bodyValue1");


        Map<String, String> legalPersonVerifyInfoMap = new HashMap<>();
//        legalPersonVerifyInfoMap.put("codeTp","bodyValue1"); //根据实际情况上送
//        legalPersonVerifyInfoMap.put("creditCode","bodyValue1"); //根据实际情况上送
//        legalPersonVerifyInfoMap.put("entName","bodyValue1"); //根据实际情况上送
        legalPersonVerifyInfoMap.put("legalRepNm", "bodyValue1");
        legalPersonVerifyInfoMap.put("idNo", "bodyValue1");

        bodyMap.put("legalPersonVerifyInfo", legalPersonVerifyInfoMap);

        // 组装风险控制信息信息域，仅提供组装方法的参考，需要根据实际进行填写字段的增加或者减少
//        Map<String, Object> riskRateInfo = new HashMap<>();
//        riskRateInfo.put("shippingFlag", "");//商品风险类别标识
//        bodyMap.put("riskRateInfo", riskRateInfo);

        Map<String, String> bsnInfoMap = new HashMap<>();
        bsnInfoMap.put("bsnScene", "bodyValue1");
        bsnInfoMap.put("bsnSceneDesc", "bodyValue1");
        bsnInfoMap.put("protocolVersion", "bodyValue1");
        bsnInfoMap.put("protocolNo", "bodyValue1");
        bodyMap.put("bsnInfo", bsnInfoMap);
