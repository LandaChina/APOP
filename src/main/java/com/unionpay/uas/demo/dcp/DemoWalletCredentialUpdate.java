 ...
 * @date 2023/5/8
 */
public class DemoWalletCredentialUpdate {

    private static final Logger logger = Logger.getLogger(DemoWalletCredentialUpdate.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "dcp.wallet.updateCrdl.apply");       // 交易类型 根据实际业务填写
        ...
        body.put("transTm", "2023-05-25 09:34:54");
        ...
        body.put("carrierId", "SU12b9EBB6e4D62dEbb828cbd4f1c1C40d79c5efdEbef");
