 ...
 * @date 2023/5/23
 */
public class DemoWalletAcctInfoInquire {
    private static final Logger logger = Logger.getLogger(DemoWalletAcctInfoInquire.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "dcp.wallet.getCrdl.inquireAcctInfo");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("cardWalletId", "00088880001");
        bodyMap.put("bankInsIdCd", "07000000011");
        bodyMap.put("transTm", "2023-05-05 09:34:54");
        bodyMap.put("transNo", "111200002023050509345412012341");
        bodyMap.put("credentialCryptData", "07244FE620000004321");

        JSONObject subBody = new JSONObject();
        subBody.put("reqReserved-1","reqReserved-1");
        bodyMap.put("reqReserved", subBody);
    ...
    public static void rsa(){
        ...
        bodyMap.put("transTm", "2023-05-05 09:34:54");
        bodyMap.put("transNo", "111200002023050509345412012341");
        bodyMap.put("credentialCryptData", "0724487420000030321");
