 ...
 * @date 2023/5/8
 */
public class DemoWalletCredentialApplyResultInquire {

    private static final Logger logger = Logger.getLogger(DemoWalletCredentialApplyResultInquire.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "dcp.wallet.getCrdl.inquireCrdlApplyR");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("transNo", "111200002023050509345412089001");
