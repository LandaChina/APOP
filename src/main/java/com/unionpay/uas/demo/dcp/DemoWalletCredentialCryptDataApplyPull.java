 ...
 * @date 2023/5/6
 */
public class DemoWalletCredentialCryptDataApplyPull {
    private static final Logger logger = Logger.getLogger(DemoWalletCredentialCryptDataApplyPull.class);
    ...
    public static void gm() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "dcp.wallet.getCrdl.applyCrdlCryptDataPull");       // 交易类型 根据实际业务填写
    ...
    public static void rsa(){
        ...
        // 组装http请求报文体 根据实际业务填写
        JSONObject body = new JSONObject();
        body.put("cardWalletId", "00088880002");
        body.put("carrierId", "SU72AIDJ21394281347KHFABFVAI72KJDSAFHKADSFGO1");
        body.put("bankInsIdCd", "07000000011");
        body.put("transTm", "2023-05-05 09:34:54");
        body.put("transNo", "010200002023050509345412088806");
