 ...
 * @date 2023/5/23
 */
public class DemoWalletBankInfoListInquire {
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "dcp.wallet.getCrdl.inquireBankInfoList");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("transTm", "2023-05-23 09:34:54");
        //bodyMap.put("nextPageId", "2");
        bodyMap.put("transNo", "000888800010008888000120230512");
    ...
    public static void rsa(){
        ...
        bodyMap.put("transTm", "2023-05-23 09:34:54");
        //bodyMap.put("nextPageId", "2");
        bodyMap.put("transNo", "000888800010008888000120230523");
