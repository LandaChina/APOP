...
import com.unionpay.uas.demo.dcp.vo.DeviceEnvInfo;
import com.unionpay.uas.demo.dcp.vo.RiskInfo;
import com.unionpay.uas.demo.dcp.vo.TokenInfo;
import com.unionpay.uas.demo.dcp.vo.UserInfo;
 ...
 * @date 2023/5/8
 */
public class DemoWalletCredentialApplyPush {

    private static final Logger logger = Logger.getLogger(DemoWalletCredentialApplyPush.class);
    ...
    public static void gm() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "dcp.wallet.getCrdl.applyCrdlPush");       // 交易类型 根据实际业务填写
        ...
        userInfo.setUserContactNm("胡匪");
        userInfo.setUserContactMobileNo("86-15952923386");
        userInfo.setUserCertifTp("01");
        userInfo.setUserCertifId("321183200001174832");
        userInfo.setUserId("heiheiheih");
        ...
        body.put("credentialCryptData", "07244FE620000004321");
    ...
    public static void rsa(){
        ...
        body.put("credentialCryptData", "0724487420000030321");
