 ...
 * @date 2023/5/23
 */
public class DemoWalletCredentialInquire {

    private static final Logger logger = Logger.getLogger(DemoWalletCredentialInquire.class);
    ...
    public static void gm(){
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "dcp.wallet.getCrdl.inquireCrdl");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("transNo", "167200002023050509345412089001");
        bodyMap.put("credentialSeqId", "DC0000000000000001F0A82606F88E8420000055");
