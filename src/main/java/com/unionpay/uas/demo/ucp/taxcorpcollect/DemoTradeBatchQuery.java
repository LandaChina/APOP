...
/**
 * 内容网关税费对公代收业务，交易状态查询(批量)接口demo
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoTradeBatchQuery {

    private static final Logger logger = Logger.getLogger(DemoTradeBatchQuery.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.ucp.trade.batch.query");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("batchNo", "0101"); //批次号，取值范围：0001-9999，当日唯一。merId+batchNo+txnTime前8位，唯一确定一笔交易
