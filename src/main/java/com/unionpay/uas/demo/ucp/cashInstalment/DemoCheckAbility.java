...
/**
 * 内容网关现金分期业务，现金分期资格查询（渠道侧->银联）demo
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoCheckAbility {

    private static final Logger logger = Logger.getLogger(DemoCheckAbility.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.ucp.cash.instalment.check.abilty");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("bussCode", "J1_9800_XJ01"); //业务代码

        // 组装encryptData
        Map<String, Object> encryptDataMap = new HashMap<>();
        encryptDataMap.put("name", "02"); //姓名
        encryptDataMap.put("idType", "01"); //证件类型,01：身份证02：军官证；03：护照；04: 回乡证；05: 台胞证；06: 警官证；07: 士兵证；99: 其它
        encryptDataMap.put("idNo", "33225909174100164520");  //证件号码
        ...
        reqInfoMap.put("merIdName", "xx商铺"); //渠道商户名
