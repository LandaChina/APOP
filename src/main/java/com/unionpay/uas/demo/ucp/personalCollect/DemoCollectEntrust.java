...
/**
 * 内容网关税费个人代收业务，税费代收签约（渠道侧->银联）demo
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoCollectEntrust {

    private static final Logger logger = Logger.getLogger(DemoCollectEntrust.class);
    ...
    public static void gm() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.ucp.tax.person.entrust.collect.establish");       // 交易类型 根据实际业务填写
...
//        collectInfo.put("presentReceive", "");//代收扣款当前期数
        ...
        // 组装账户验证信息域，仅提供组装方法的参考，需要根据实际进行修改;账号,手机号、姓名、证件类型/证件、短信验证码必填
