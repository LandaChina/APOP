...
public class DemoBillPay {
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "ucp.trade.bill.pay");       // 交易类型 根据实际业务填写
        ...
        billMap1.put("billQueryId", "33225909174100164520  020220124");
    ...
    public static void RsaDemo() {
        ...
        billMap1.put("index", "01");
        billMap1.put("code", "S0_9800_0003");
        billMap1.put("billQueryId", "33242609080300164520  020220207");
