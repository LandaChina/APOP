...
/**
 * 内容网关现金分期业务，现金分期交易历史查询（渠道侧->银联）demo
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoHistoryQuery {

    private static final Logger logger = Logger.getLogger(DemoHistoryQuery.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.ucp.cash.instalment.history.query");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("bussCode", "J1_9800_XJ05"); //业务代码
        ...
        reqInfoMap.put("beginDate", "20230102"); //开始日期,格式：YYYYMMDD
        reqInfoMap.put("endDate", "20230105"); //结束日期,格式：YYYYMMDD
    ...
    public static void RsaDemo() {
        ...
        //请求信息域	reqInfo
        Map<String, Object> reqInfoMap = new HashMap<>();
        reqInfoMap.put("beginDate", "20230103"); //开始日期,格式：YYYYMMDD
        reqInfoMap.put("endDate", "20230105"); //结束日期,格式：YYYYMMDD
        reqInfoMap.put("merIdName", "xx商铺"); //渠道商户名
        bodyMap.put("reqInfo", JSONObject.wrap(reqInfoMap).toString());
