...
/**
 * 内容网关税费个人代收业务，交易状态查询（渠道侧->银联）demo
 * 声明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己需要，按照技术文档编写。该代码仅供参考，不提供编码，性能，规范性等方面的保障<br>
 */
public class DemoCollectTradeQuery {

    private static final Logger logger = Logger.getLogger(DemoCollectTradeQuery.class);
    ...
    public static void gm() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "upntAcp.ucp.trade.query");       // 交易类型 根据实际业务填写
        ...
        bodyMap.put("merId", "");//商户代码,与待查询代收交易保持一致
        bodyMap.put("orderId", "");//商户订单号,与待查询代收交易保持一致
        bodyMap.put("txnTime", "");//交易发送时间,与待查询代收交易保持一致
