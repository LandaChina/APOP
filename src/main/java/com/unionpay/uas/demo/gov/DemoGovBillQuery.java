...
public class DemoGovBillQuery {

    private static final Logger logger = Logger.getLogger(DemoGovBillQuery.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "soluSce.gov.trade.cont.bill.query");       // 交易类型 根据实际业务填写
        ...
        encDataMap.put("usr_num", "12345678912345679"); //证件号码
        encDataMap.put("id_tp", "01");//证件类型
        ...
        //{"code":"S2_5800_0010","form":{"product_tp":"10212",,"query_month":"202400","meter_use_value":"","id_tp":"01","col_voucher_no":"xxx","col_organ_cd":"22000011000014306883234567"}}
        //对上述的jsonstr进行base64塞如Billdetailinfo里
        bodyMap.put("billDetailInfo", "eyJjb2RlIjoiUzJfNTgwMF8wMDEwIiwiZm9ybSI6eyJwcm9kdWN0X3RwIjoiMTAyMTIiLCwicXVlcnlfbW9udGgiOiIyMDI0MDAiLCJtZXRlcl91c2VfdmFsdWUiOiIiLCJpZF90cCI6IjAxIiwiY29sX3ZvdWNoZXJfbm8iOiJ4eHgiLCJjb2xfb3JnYW5fY2QiOiIyMjAwMDAxMTAwMDAxNDMwNjg4MzIzNDU2NyJ9fQ=="); //请求信息域
//        bodyMap.put("bussInfo", Base64.toBase64String("123456789".getBytes())); //用户号码
    ...
    public static void RsaDemo() {
        ...
        bodyMap.put("txnTime", DemoUtil.getTxnTime()); //订单发送时间，格式为yyyyMMddHHmmss，取北京时间，此处为演示方便默认取了个值
        //{"code":"S2_5800_0010","form":{"product_tp":"10212",,"query_month":"202400","meter_use_value":"","id_tp":"01","col_voucher_no":"xxx","col_organ_cd":"22000011000014306883234567"}}
        //对上述的jsonstr进行base64塞进Billdetailinfo里
        bodyMap.put("billDetailInfo", "eyJjb2RlIjoiUzJfNTgwMF8wMDEwIiwiZm9ybSI6eyJwcm9kdWN0X3RwIjoiMTAyMTIiLCwicXVlcnlfbW9udGgiOiIyMDI0MDAiLCJtZXRlcl91c2VfdmFsdWUiOiIiLCJpZF90cCI6IjAxIiwiY29sX3ZvdWNoZXJfbm8iOiJ4eHgiLCJjb2xfb3JnYW5fY2QiOiIyMjAwMDAxMTAwMDAxNDMwNjg4MzIzNDU2NyJ9fQ=="); //请求信息域
//        bodyMap.put("bussInfo", Base64.toBase64String("123456789".getBytes())); //用户号码
        bodyMap.put("reqReserved", "reqReserved");
        reqData.put(SDKConstants.param_body, JSONObject.wrap(bodyMap).toString());
