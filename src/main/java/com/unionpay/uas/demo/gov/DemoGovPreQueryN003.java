...
public class DemoGovPreQueryN003 {

    private static final Logger logger = Logger.getLogger(DemoGovPreQueryN003.class);
...
//        RsaDemo();
    ...
    public static void GmDemo() {
        ...
        reqInfoJson.put("entrust_dt","20240703");//委托日期
        reqInfoJson.put("ss_agen_cd","37019B01");//委托日期
        reqInfoJson.put("col_proj_cd","10203");//委托日期
        reqInfoJson.put("pay_dt_strt","202011");//委托日期
//        reqInfoJson.put("spe_cate_cd","301D");
        Map<String, Object> bodyMap = new HashMap<>();
        Map<String, Object> encDataMap = new HashMap<>(); // 需要加密的敏感信息报文 根据实际业务填写
        encDataMap.put("cert_num", "123456789123456798"); //证件号码
...
//        bodyMap.put(SDKConstants.param_encryptData, toBeEncMap); // 如果不需要携带敏感信息并由网关解密, 则注释这行代码
        ...
        bodyMap.put("bussCode", "S2_4500_N003"); //业务代码
