 ...
 */
public class Demo01BillQuery {

    private static final Logger logger = Logger.getLogger(Demo01BillQuery.class);
    ...
    public static void GmDemo() {
        ...
        // 组装HTTP请求报文头
        reqData.put(SDKConstants.param_bizMethod, "ucp.trade.cont.bill.query");       // 交易类型 根据实际业务填写
        ...
        billDetailInfoMap.put("code", "S0_9800_0003");
